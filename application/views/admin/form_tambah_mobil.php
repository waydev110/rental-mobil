        	...
        	<div class="card-body">
        		...
        		<div class="row">
        			<div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label>AC</label>
                            <select name="ac" class="form-control"><option value="1">Tersedia</option>
                        ...
                        <div class="form-group">
                            <label>Supir</label>
                            <select name="supir" class="form-control"><option value="1">Tersedia</option>
                                    <option value="0">Tidak Tersedia</option>
                        ...
                        <div class="form-group">
                            <label>MP3</label>
                            <select name="mp3_player" class="form-control"><option value="1">Tersedia</option>
                                    <option value="0">Tidak Tersedia</option>
                        ...
                        <div class="form-group">
                            ...
                            <select name="central_lock" class="form-control"><option value="1">Tersedia</option>
                                    <option value="0">Tidak Tersedia</option>
        			...
        			<div class="col-md-6">
        				...
        				<button type="reset" class="btn btn-danger mt-4 ml-2">Reset
        				</button>
        			</div>
        		</div>
        		</form>
